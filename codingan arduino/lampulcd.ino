...
const char* topik = "iot/kendali/G.231.22.0019";
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (messages == "D7=1") {
    ...
    showNotification("Lampu 4 ON");
  }
  if (messages == "D7=0") {
    digitalWrite(lampu4, LOW);
    showNotification("Lampu 4 OFF");
  }
  if (messages == "D8=1") {
    digitalWrite(lampu5, HIGH);
    showNotification("Lampu 5 ON");
  }
  if (messages == "D8=0") {
    digitalWrite(lampu5, LOW);
    showNotification("Lampu 5 OFF");
  }
