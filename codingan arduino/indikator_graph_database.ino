...
const char* ssid = "Frmn1134";   
const char* password = "firmanwifi";   
const char* mqtt_server = "test.mosquitto.org";   
const char* user_mqtt = "";   
const char* pass_mqtt = "";   

// Topik MQTT
const char* topik_temp = "iot/kendali/firmantemp";
const char* topik_hum = "iot/kendali/firmanhumd";
const char* topik_lampu1 = "iot/kendali/firmanlampu1";
const char* topik_lampu2 = "iot/kendali/firmanlampu2";
const char* topik_lampu3 = "iot/kendali/firmanlampu3";
...
void reconnect() {   
    while (!client.connected()) {   
        ...
        if (client.connect("G.231.22.0019", user_mqtt, pass_mqtt)) {   
